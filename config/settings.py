...
class Settings(BaseSettings):
    ...
    # Supabase Configuration - Add these fields to fix the validation error
    supabase_url: Optional[str] = None
    supabase_key: Optional[str] = None
    
    # SendGrid Email Configuration
    sendgrid_api_key: Optional[str] = None
    sendgrid_from_email: str = "noreply@yourcompany.com"  # Change this to your verified sender
    sendgrid_from_name: str = "InfluencerFlow AI"
    ...
    similarity_threshold: float = 0.3  # Lowered for debugging
    ...
    class Config:
        ...
        extra = "ignore"  # This will ignore extra environment variables instead of failing
...
def debug_settings():
    ...
    print(f"   SENDGRID_API_KEY: {'✅ Set' if settings.sendgrid_api_key else '❌ Missing'}")
